...
public final class Lexer202310 {
  ...
  public static ITransducer createLexer() {
    ...
    $try:try {
      ...
      $line=107;
      Object \u03A3=$fix($opUnionY($opUnionY($opUnionY(alphaNum,Lexer202310.charsStrings(allSymbols)),skipChars),GCollections.asSet(':','-','_')));
      $line=110;
      Object q_0=$fix("INIT");
      $line=111;
  ...
  public static Object initialize() {
    ...
    $try:try {
      ...
      $line=221;
      keyWords=$cast(ISet.class,$fix(GCollections.asSet("ROBOT_R","VARS","PROCS","assignTo","goto","move","turn","face","jumpInDir","nop","right","left","around","north","put","pick","moveToThe","moveInDir","jumpToThe","south","east","west","front","back","balloons","chips","while","if","then","else","do","repeat","facing","canPut","canPick","canMoveInDir","canJumpInDir","canMoveToThe","canJumpToThe","not")));
      $line=223;
      ...
      $line=227;
      ((gold.structures.map.GHashTableMap)translation).put("right",'d');
      $line=228;
      ((gold.structures.map.GHashTableMap)translation).put("south",'c');
      $line=229;
      ((gold.structures.map.GHashTableMap)translation).put("west",'c');
      $line=230;
      ...
      $line=235;
      ((gold.structures.map.GHashTableMap)translation).put("canMoveToThe",'M');
      $line=236;
      ...
      $line=242;
      ((gold.structures.map.GHashTableMap)translation).put("canMoveInDir",'I');
      $line=243;
      ((gold.structures.map.GHashTableMap)translation).put("left",'d');
      $line=244;
      ((gold.structures.map.GHashTableMap)translation).put("jumpToThe",'M');
      $line=245;
      ((gold.structures.map.GHashTableMap)translation).put("around",'d');
      $line=246;
      ((gold.structures.map.GHashTableMap)translation).put("north",'c');
      $line=247;
      ((gold.structures.map.GHashTableMap)translation).put("turn",'t');
      $line=248;
      ((gold.structures.map.GHashTableMap)translation).put("front",'d');
      $line=249;
      ((gold.structures.map.GHashTableMap)translation).put("back",'d');
      $line=250;
      ((gold.structures.map.GHashTableMap)translation).put("balloons",'B');
      $line=251;
      ((gold.structures.map.GHashTableMap)translation).put("facing",'f');
      $line=252;
      ((gold.structures.map.GHashTableMap)translation).put("chips",'B');
      $line=253;
      ((gold.structures.map.GHashTableMap)translation).put("VARS",'V');
      $line=254;
      ((gold.structures.map.GHashTableMap)translation).put("canJumpToThe",'M');
      $line=255;
      ((gold.structures.map.GHashTableMap)translation).put("not",'0');
      $line=256;
      ((gold.structures.map.GHashTableMap)translation).put("canJumpInDir",'I');
      $line=257;
      ((gold.structures.map.GHashTableMap)translation).put("canPut",'p');
      $line=258;
      ((gold.structures.map.GHashTableMap)translation).put("canPick",'p');
      $line=259;
      ...
      $line=264;
      ((gold.structures.map.GHashTableMap)translation).put("east",'c');
      $line=268;
